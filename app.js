...
// Coût des composants (selon ton tableau de prix) :
// Pack 99  -> 72.75 DH  (marge ~26 DH)
// Pack 199 -> 146.75 DH (marge ~52 DH)
// Pack 299 -> 218.40 DH (marge ~81 DH)
// oldPrice = prix barré marketing (à ajuster selon ton vrai prix normal de vente)
const PACKS = [
  {
    id: 'pack1', name: 'باقة البركة', desc: 'خضرة وفاكهة بثمن يفرح الجيب',
    price: 99, oldPrice: 129, discount: 23, unit: 'باقة', emoji: '🧺',
    img: 'fresh vegetables fruits basket', photo: 'images/1.png', cartPhoto: 'images/i1.png',
    items: [
      { name: 'طماطم',       qty: 2,   unit: 'kg' },
      { name: 'بطاطا',       qty: 1.5, unit: 'kg' },
      { name: 'بصل',         qty: 1,   unit: 'kg' },
      { name: 'جزر',         qty: 1,   unit: 'kg' },
      { name: 'خيار',        qty: 1,   unit: 'kg' },
      { name: 'ڭرعة خضرا',   qty: 1,   unit: 'kg' },
      { name: 'فلفلة خضرا',  qty: 0.5, unit: 'kg' },
      { name: 'معدنوس',      qty: 1,   unit: 'قبطة' },
      { name: 'قزبر',        qty: 1,   unit: 'قبطة' },
      { name: 'برتقال',      qty: 2,   unit: 'kg' },
    ],
    freebies: ['نعناع مجاني 🌿', '2 ليمونات مجانا 🍋'],
  },
  {
    id: 'pack2', name: 'باقة العائلة', desc: ' خضرة للطاجين والسلاطة مع فواكه',
    price: 199, oldPrice: 249, discount: 20, unit: 'باقة', emoji: '👨‍👩‍👧‍👦',
    img: 'family vegetables fruits crate', photo: 'images/2.png', cartPhoto: 'images/i2.png',
    items: [
      { name: 'طماطم',       qty: 3,    unit: 'kg' },
      { name: 'بطاطا',       qty: 3,    unit: 'kg' },
      { name: 'بصل',         qty: 2,    unit: 'kg' },
      { name: 'جزر',         qty: 1.5,  unit: 'kg' },
      { name: 'خيار',        qty: 1.5,  unit: 'kg' },
      { name: 'ڭرعة خضرا',   qty: 1.5,  unit: 'kg' },
      { name: 'دنجال',       qty: 1,    unit: 'kg' },
      { name: 'فلفلة خضرا',  qty: 1,    unit: 'kg' },
      { name: 'تومة',        qty: 0.25, unit: 'kg' },
      { name: 'خس',          qty: 1,    unit: 'راس' },
      { name: 'معدنوس',      qty: 2,    unit: 'قبطة' },
      { name: 'قزبر',        qty: 2,    unit: 'قبطة' },
      { name: 'برتقال',      qty: 2,    unit: 'kg' },
      { name: 'تفاح أحمر',   qty: 1,    unit: 'kg' },
    ],
    freebies: ['نعناع مجاني 🌿', '2 ليمونات مجانا 🍋'],
  },
  {
    ...
    items: [
      { name: 'طماطم',        qty: 4,   unit: 'kg' },
      { name: 'بطاطا',        qty: 4,   unit: 'kg' },
      { name: 'بصل',          qty: 2,   unit: 'kg' },
      { name: 'جزر',          qty: 2,   unit: 'kg' },
      { name: 'خيار',         qty: 2,   unit: 'kg' },
      { name: 'ڭرعة خضرا',    qty: 2,   unit: 'kg' },
      { name: 'دنجال',        qty: 1,   unit: 'kg' },
      { name: 'فلفلة خضرا',   qty: 1,   unit: 'kg' },
      { name: 'فلفلة حمرا',   qty: 1,   unit: 'kg' },
      { name: 'تومة',         qty: 0.5, unit: 'kg' },
      { name: 'خس',           qty: 2,   unit: 'راس' },
      { name: 'ليمون',        qty: 1,   unit: 'kg' },
      { name: 'معدنوس',       qty: 2,   unit: 'قبطة' },
      { name: 'قزبر',         qty: 2,   unit: 'قبطة' },
      { name: 'برتقال',       qty: 3,   unit: 'kg' },
      { name: 'تفاح أحمر',    qty: 1,   unit: 'kg' },
      { name: 'خوخ',          qty: 1,   unit: 'kg' },
    ],
    freebies: ['نعناع مجاني 🌿', 'كيس عنب صغير مجاني 🍇'],
  },
];
